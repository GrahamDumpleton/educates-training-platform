...
def git_workshop_spec_patches(workshop_spec, git_properties):
...
def git_environment_objects_list(workshop_spec, git_properties):
    return []


def git_session_objects_list(workshop_spec, git_properties):
    return []


def git_pod_template_spec_patches(workshop_spec, git_properties):
    return {}
